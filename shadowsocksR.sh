...
libsodium_url="https://github.com/jedisct1/libsodium/archive/1.0.18-RELEASE.tar.gz"
...
pre_install(){
    ...
    read -p "(Default password: love1998):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="love1998"
    echo
    echo "---------------------------"
